...
#    python simular.py --model hill
#
# 4) Inhibición por sustrato:
#    python simular.py --model substrate_inhibition
#
# 5) Inhibición competitiva con [I]=1.0 y Ki=5.0 usando Michaelis-Menten:
#    python simular.py --model michaelis --inhibitor_type competitive --inhibitor_conc 1.0 --ki_inhibitor 5.0
#
# 6) Hill + Inhibición competitiva:
#    python simular.py --model hill --inhibitor_type competitive --inhibitor_conc 2.0 --ki_inhibitor 10.0
#
# 7) Leer parámetros desde un archivo JSON:
#    python simular.py --param_file parametros.json
#
