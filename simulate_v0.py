...
#    --km 2.0 \
#    --hill_coeff 1.0 \
#    --substrates 0.02 0.05 0.1 0.2 0.3 0.5 1 2 5 10 20 40 \
#    --replicates 3 \
#    --noise_scale 0.1 \
#    --seed 1 \
#    --inhibitor_type none \
...
def quick_plot(df, output_path):
    ...
    # Estilo solicitado
    plt.xlabel("[S] (Concentration units)", fontsize=22, fontweight='bold')
...
def main():
    ...
    parser.add_argument("--vmax", type=float, default=10.0, help="Velocidad máxima (default: 10.0)")
    parser.add_argument("--km", type=float, default=2.0, help="Constante KM (default: 2.0)")
    parser.add_argument("--hill_coeff", type=float, default=1.0, help="Coeficiente de Hill (default: 1.0)")
    ...
    parser.add_argument("--substrates", nargs="+", type=float, default=[0.02, 0.05, 0.1, 0.2, 0.3, 0.5, 1, 2, 5, 10, 20, 40],
                        help="Concentraciones de sustrato (default: 0.02 0.05 0.1 0.2 0.3 0.5 1 2 5 10 20 40)")
    parser.add_argument("--replicates", type=int, default=5, help="Número de réplicas (default: 5)")
    parser.add_argument("--noise_scale", type=float, default=0.2, help="Escala del ruido (default: 0.2)")
    parser.add_argument("--seed", type=int, default=1, help="Semilla para reproducibilidad (default: 1)")
